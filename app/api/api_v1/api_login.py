...
@router.post('/login/test-token', response_model=DataResponse[UserBase])
def test_token(current_user: models.User = Depends(UserService.get_instance().get_current_user)):
